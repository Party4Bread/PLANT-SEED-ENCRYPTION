...
namespace SeedCs
{
	public class SEED
    {
        ...
        public static void SeedEncRoundKey(ref uint[] pRoundKey, byte[] UserKey)
        {
            uint A, B, C, D, T0, T1;
            uint[] K = pRoundKey;
        ...
        public static void SeedEncryptBlock(ref byte[] pData, uint[] RoundKey)
        {
            uint L0, L1, R0, R1;
            uint[] K = RoundKey;
            ...
            SeedRound(ref L0, ref L1, R0, R1, K, 0);        // Round 1
            SeedRound(ref R0, ref R1, L0, L1, K, 2);        // Round 2
            SeedRound(ref L0, ref L1, R0, R1, K, 4);        // Round 3
            SeedRound(ref R0, ref R1, L0, L1, K, 6);        // Round 4
            SeedRound(ref L0, ref L1, R0, R1, K, 8);        // Round 5
            SeedRound(ref R0, ref R1, L0, L1, K, 10);       // Round 6
            SeedRound(ref L0, ref L1, R0, R1, K, 12);       // Round 7
            SeedRound(ref R0, ref R1, L0, L1, K, 14);       // Round 8
            SeedRound(ref L0, ref L1, R0, R1, K, 16);       // Round 9
            SeedRound(ref R0, ref R1, L0, L1, K, 18);       // Round 10
            SeedRound(ref L0, ref L1, R0, R1, K, 20);       // Round 11
            SeedRound(ref R0, ref R1, L0, L1, K, 22);       // Round 12
            SeedRound(ref L0, ref L1, R0, R1, K, 24);       // Round 13
            SeedRound(ref R0, ref R1, L0, L1, K, 26);       // Round 14
            SeedRound(ref L0, ref L1, R0, R1, K, 28);       // Round 15
            SeedRound(ref R0, ref R1, L0, L1, K, 30);       // Round 16
        ...
        public static void SeedDecryptBlock(ref byte[] pData, uint[] RoundKey)
        {
